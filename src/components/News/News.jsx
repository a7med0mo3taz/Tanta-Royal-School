...
export default function News() {
    ...
    return (
        <div className={`News & EventPage h-full ${darkMode ? "bg-[#030712]" : "bg-white "}  transition-all duration-500 ease-in-out`}>
            {/* heading section */}
            ...
            xl:h-[515px] `}>
                ...
                >
                    ...
                    <div className="Breadcrumb text-[#aaaaaa] text-lg flex justify-center  ">
                        ...
                        <span className='font-almarai font-bold my-auto'>  {t("News & Event")} </span>
                    </div>
                </div>
