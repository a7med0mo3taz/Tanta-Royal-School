...
export default function British() {
  ...
  return (
    <div className='British Page'>
      ...
      {/* section 1 */}
      <section className={` relative overflow-hidden min-h-[700px] transition-all duration-500 ease-in-out
                  md:min-h-[800px] 
                  lg:min-h-[616px]
        ...
        <div className="container grid  mx-auto p-3  inset-0  z-20 absolute
          ...
          <div className="left  mx-auto col-span-12  relative max-w-[640px] gap-5 flex flex-col  justify-center items-center 
            ...
            <div onMouseMove={handleMouseMove}
              ...
              style={{ perspective: "1000px" }}
              className=" mx-auto ">
              <img src={international1} style={style} alt="international1" className="w-[250px]  sm:w-[400px] mx-auto h-full object-cover rounded-xl " loading='lazy' />
            </div>
