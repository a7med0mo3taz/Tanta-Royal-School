...
export default function Blog() {
    ...
    return (
        <div className={`BlogPage h-full ${darkMode ? "bg-[#030712]" : "bg-white "}  transition-all duration-500 ease-in-out`}>
            {/* heading section */}
            ...
            xl:h-[515px] `}>
                ...
                >
                    ...
                    <div className="Breadcrumb text-white text-lg flex justify-center  ">
                        ...
                        <span className='font-almarai font-bold my-auto'>  {t("BlogTitle")} </span>
                    </div>
                </div>
